...
const ContactUs = ({ setSelectedPage }: Props) => {
  ...
  return (
    <section id="contactus" className="mx-auto w-5/6 pb-36 pt-24">
      <motion.div
        className=""
      ...
      >
        ...
        <div className=" mt-10 justify-between gap-8 md:flex">
          ...
          >
            <form target="_blank" onClick={onSubmit}
            method="POST"
            action="https://formsubmit.co/bda038fdcea6264163fd93db09f2cb0a"
            >
